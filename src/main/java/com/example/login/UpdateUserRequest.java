...
public class UpdateUserRequest {
    ...
    public UpdateUserRequest(String name, String email_id, String mob, String address, String date_of_purchase, String invoice_number, String device_id, String services_offered) {
        this.name = name;
